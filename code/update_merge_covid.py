...
bev_p = proj_dir    / 'data/02_pre_processed/bev.csv'
kh_p = proj_dir     / 'data/02_pre_processed/krankenh.csv'
pflegebed_p = proj_dir / 'data/02_pre_processed/pflegebed.csv'
hochschulen_p = proj_dir / 'data/02_pre_processed/numhochschulen_per_plz.csv'
